...
import com.axondragonscale.noteapp.presentation.notes.components.NoteItem
import com.axondragonscale.noteapp.presentation.notes.components.OrderSection
...
fun NotesScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            AnimatedVisibility(
                visible = state.showOrderSection,
